...
`model.joblib` is the final role-fit decision model used by the M4/M5 system. It combines word and character TF-IDF features with a linear support-vector classifier.
...
- Rebuild command: `python -m jobmatch.train`.
